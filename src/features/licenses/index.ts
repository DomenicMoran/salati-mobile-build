...
export const LICENSE_TEXT_TITLES: Record<LicenseTextId, string> = {
  ...
  'quranic-arabic-corpus': 'Quranic Arabic Corpus — Nutzungsbedingungen',
...
export const LICENSE_TEXT_WORKS: Record<LicenseTextId, string> = {
  ...
  mit: 'React, React Native, Expo, Ionicons, llama.cpp, whisper.cpp, ggml, Hermes, Fresco, adhan, zod, TanStack Query, NoorBayan/Quranic …',
  ...
  'quranic-arabic-corpus': 'Wortmorphologie (Wortarten, Wurzeln, Grundformen, Merkmale) im Koran-Lexikon',
