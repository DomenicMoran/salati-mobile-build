...
export const LERNEN_NAV = [
  ...
  { href: '/gebet-gemeinsam', labelKey: 'gebetGemeinsam.title', icon: 'people-outline' },
  { href: '/lexikon', labelKey: 'nav.lexikon', icon: 'bookmarks-outline' },
  { href: '/analyse-uebung', labelKey: 'analyseUebung.title', icon: 'create-outline' },
